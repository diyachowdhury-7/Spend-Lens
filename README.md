...
Unlike a basic expense tracker that shows what you spent on, this reveals how you behave like high-spend end-of-month bursts, 
...
Normalization: applies z-score standardization (StandardScaler) so no feature dominates distance calculations; 
chosen over min-max specifically for outlier robustness
